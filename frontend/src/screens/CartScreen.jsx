                        ...
                        {cartItems.map((item) => (
                            <ListGroup.Item key={item._id}>
                                <Row>
                                    ...
                                    <Col md={2} >
                                        <Form.Select as="select" value={item.qty} onChange={(e) => {addToCartHandler(item, Number(e.target.value))}}>
                ...
                <Card>
                    <ListGroup variant='flush'>
                        <ListGroup.Item>
                            ...
                            ${cartItems.reduce((acc, item) => acc + item.qty * item.price, 9).toFixed(2)}
                        </ListGroup.Item>
                        <ListGroup.Item>
